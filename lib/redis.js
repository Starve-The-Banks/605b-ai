...
function getRedis() {
  ...
  // In production, a missing Redis connection means payment idempotency and rate limiting
  // are silently broken. Throw hard so the misconfiguration is caught immediately.
  if (process.env.NODE_ENV === 'production') {
    throw new Error(
      '[redis] FATAL: No Redis env vars found in production. ' +
