 ...
 * @property {'review_only'|'informational'|'potential_issue'|'high_priority_issue'} category
 ...
 * @property {number} collectionLikeMarkerCount
 * @property {Record<string, number>} emittedByCategory
 * @property {Record<string, number>} emittedByIssueType
