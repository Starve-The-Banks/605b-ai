...
export function useUserTier() {
  ...
  }, [features, tierData, isAccessFrozen, isAccessRevoked]);
  ...
  const getBlockedReason = useCallback((action) => {
    if (isAccessRevoked) {
      return {
        blocked: true,
        reason: 'revoked',
        message: 'Your access has been revoked due to a billing issue. Please contact support.',
      };
    }
    if (isAccessFrozen && FROZEN_BLOCKED_ACTIONS.includes(action)) {
      return {
        blocked: true,
        reason: 'frozen',
        message: 'Access temporarily restricted due to a billing dispute. Please contact support to resolve.',
      };
    }
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ fontSize: '14px', color: '#a1a1aa', lineHeight: 1.5 }}>
            Your account access has been revoked due to a billing issue. 
            Please contact <a href="mailto:support@9thwave.io" style={{ color: '#ef4444' }}>support@9thwave.io</a> to resolve this.
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div style={{
        ...
        <div>
          ...
          <div style={{ fontSize: '14px', color: '#a1a1aa', lineHeight: 1.5 }}>
            Your account access is temporarily restricted due to a billing dispute. 
            You can still view your dashboard, but exports and downloads are disabled until resolved.
            Please contact <a href="mailto:support@9thwave.io" style={{ color: '#fbbf24' }}>support@9thwave.io</a> to resolve this.
          </div>
        </div>
      </div>
    );
